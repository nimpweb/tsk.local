...
<head>
    ...
    <!-- Material Design -->
    <link rel="stylesheet" href="/assets/admin/css/bootstrap-material-design.min.css">
    <link rel="stylesheet" href="/assets/admin/css/ripples.min.css">
    <link rel="stylesheet" href="/assets/admin/css/MaterialAdminLTE.min.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="/assets/admin/css/skins/all-md-skins.min.css">
    <!-- Morris chart -->
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>кабинет</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">Личный<b>кабинет</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            <!-- Sidebar user panel -->
            <div class="user-panel" style="background-image: url('/images/client/mk-energo/logo.jpg'); background-size: cover; padding: 80px 20px;">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="index.html"><i class="fa fa-list"></i> Список</a></li>
                        <li><a href="index.html"><i class="fa fa-list"></i> Заявки</a></li>
                        <li><a href="index.html"><i class="fa fa-list"></i> Показания приборов учета</a></li>
                        <li><a href="index.html"><i class="fa fa-list"></i> Обращения</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=ADMIN?>/settings/requisites"><i class="fa fa-list"></i> Реквизиты</a></li>
                        <li><a href="<?=ADMIN?>/settings/sending"><i class="fa fa-send"></i> Рассылки</a></li>
                        <li><a href="<?=ADMIN?>/settings/gp"><i class="fa fa-bank"></i> ГП</a></li>
                    </ul>
                </li>
                <li>
                    <a href="/user/logout">
    ...
    <footer class="main-footer">
        ...
        <strong>2020, <a href="https://webstudio56.ru">webStudio<span style="color: #00a65a">56</span></a> все права защищены, <a class="other-copy__link" href="#">также</a>
        <div class="other-copy">Copyright &copy; 2014-2018 <a href="http://almsaeedstudio.com">Almsaeed Studio</a>, <a href="https://fezvrasta.github.io">Federico Zivolo</a> and <a href="https://ducthanhnguyen.github.io">Thanh Nguyen</a>.</strong>... </div>
        reserved.
    </footer>
...
<script>
    const otherCopyLink = document.querySelector('.other-copy__link');
    if (otherCopyLink) {
        otherCopyLink.addEventListener('click', event => {
           event.preventDefault();
           const otherCopy = document.querySelector('.other-copy');
           if (otherCopy) {
               if (otherCopy.style.display === 'block') { otherCopy.style.display = 'none' }
               else { otherCopy.style.display = 'block'; }
           }
        });
    }
</script>
...
<!-- Material Design -->
<script src="/assets/admin/js/material.min.js"></script>
<script src="/assets/admin/js/ripples.min.js"></script>
<script>
    $.material.init();
</script>
<!-- Morris.js charts -->
